    ...
    <body>
        <main class="container">
            <form action="/respostaExer5" method="POST">
                ...
                <div class="row">
                    <div class="col">
                        <label class="form-label">Informe a primeira nota: </label>
                        <input type="number" name="p1" class="form-control"/>
                    </div>
                    <div class="col">
                        <label class="form-label">Informe a segunda nota: </label>
                        <input type="number" name="p2" class="form-control"/>
                    </div>
                    <div class="col">
                        <label class="form-label">Informe a terceira nota: </label>
