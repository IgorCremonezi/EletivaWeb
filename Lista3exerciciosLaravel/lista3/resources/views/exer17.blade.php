    ...
    <body>
        <main class="container">
            <form action="/respostaExer17" method="POST">
                ...
                <div class="row">
                    <div class="col">
                        <label class="form-label">Informe o valor do capital: </label>
                        <input type="number" name="capital" class="form-control"/>
                    </div>
                    <div class="col">
                        <label class="form-label">Informe a taxa de juros: </label>
                        <input type="text" name="juros" class="form-control"/>
                    </div>
                    <div class="col">
                        <label class="form-label">Informe o período: </label>
